      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="w-16 h-0.5 bg-primary mx-auto rounded-full mb-4" />
            <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
              Khám phá sự thay đổi tuyệt vời của khách hàng sau khi sử dụng dịch
              vụ của chúng tôi
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            {beforeAfterGallery.map((item) => (
              <div
                key={item.id}
                className="group bg-background/60 backdrop-blur-sm rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-500 relative"
              >

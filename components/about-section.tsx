        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
              ...
              chúng tôi cam kết mang đến cho khách hàng những dịch vụ thẩm mỹ
              tốt nhất
            </p>
          </motion.div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4 sm:mb-6 text-sm sm:text-base">
                    Hành trình phát triển của chúng tôi là minh chứng cho sự nỗ
                    lực không ngừng trong việc mang đến vẻ đẹp tự nhiên và sự tự
                    tin cho khách hàng.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {teamMembers.map((member) => (
                <motion.div key={member.name} variants={fadeInUp}>
                  <div className="group relative bg-background rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
